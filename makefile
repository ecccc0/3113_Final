# Source and target
TARGET := game
SRCS = main.cpp lib/cs3113.cpp lib/Entity.cpp lib/Map.cpp lib/Scene.cpp lib/ShaderProgram.cpp lib/Effects.cpp scenes/LevelOne.cpp scenes/CombatScene.cpp
BINARY := $(TARGET)
